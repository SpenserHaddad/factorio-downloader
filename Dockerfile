...
RUN echo "*/15 * * * * uv run --directory /factorio-downloader python -m factorio_downloader --version=latest --build=expansion --outdir=/downloaded >> /downloaded/factorio-dl.log 2>&1" >> /etc/cron.d/factorio-dl
